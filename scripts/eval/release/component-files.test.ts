...
describe("release evaluator component file set", () => {
	it("binds current evaluator and observer scoring behavior without claiming subject prompts", async () => {
		...
		expect(manifest.components.evaluator).not.toContain("packages/core/src/ingest-prompts.ts");
