...
Raw-event fallback notices identify the Viewer stage and safe cause. Structured app logs also report Viewer and CLI elapsed time, CLI attempt count, and a sanitized CLI failure cause without exposing endpoints, paths, payloads, or subprocess output.
