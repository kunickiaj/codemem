...
export async function loadStats(options: ReadRequestOptions = {}): Promise<unknown> {
...
export async function loadUsage(
	...
	return fetchJson(`/api/usage?project=${encodeURIComponent(project)}`, options);
}
...
export async function loadSession(
	...
	return fetchJson(`/api/session?project=${encodeURIComponent(project)}`, options);
}
...
export async function loadRawEvents(
	...
	return fetchJson(`/api/raw-events?project=${encodeURIComponent(project)}`, options);
}
