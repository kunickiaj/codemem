...
import { renderDevicesPanel } from "./coordinator-admin/components/devices-panel";
...
import { renderJoinRequestsPanel } from "./coordinator-admin/components/join-requests-panel";
